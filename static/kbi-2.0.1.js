...
$(document).ready(function () {
    ...
    if (kbi_init_props["disableSwitch"] === false) {
        ...
        style="background-color: #135afe; padding: 5px 5px 5px 5px; width: 300px; height: 62px; 
    ...
    // Rasa Webchat Styles
    if (kbi_init_props["disableRasaWebchatStyles"] === false) {
        var rw_styles = document.createElement('style');
        rw_styles.innerHTML = `
        .rw-launcher {
            background-color: ` + kbi_init_props["widgetLauncherColor"] + ` !important;
            box-shadow: 0px 0px !important;
        }
        .rw-header {
            background-color: ` + kbi_init_props["widgetHeaderColor"] + ` !important;
        }
        /*.rw-title {
            font-size: 16px !important;
        }*/
        .rw-sender, .rw-new-message, .rw-send {
            background-color: ` + kbi_init_props["widgetMessageAreaColor"] + ` !important;
            font-color: white;
        }
        .rw-client {
            background-color: ` + kbi_init_props["widgetUserUtteredColor"] + ` !important;
        }
        .rw-reply {
            background-color: ` + kbi_init_props["widgetButtonColor"] + ` !important;
            border-color: ` + kbi_init_props["widgetButtonColor"] + ` !important;
        }
        .rw-response {
            background-color: ` + kbi_init_props["widgetBotUtteredColor"] + ` !important;
        }
        .rw-send  {
            background-image: url(" ` + kbi_init_props["widgetSendMessageImage"] + ` ") !important;
            background-size: ` + kbi_init_props["widgetSendMessageImageSize"]["width"] + ` ` + kbi_init_props["widgetSendMessageImageSize"]["height"] + ` !important;
